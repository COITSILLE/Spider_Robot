...
参照https://vscode.js.cn/docs/sourcecontrol/merge-conflicts解决
...
点进去，
<img src="./mdpic/15.png" alt="PR" width="60%" height="60%">  
这意味着提交将分支`coop`merge(合并)到主分支`main`，写好必要的说明即可

## 5. 合并

<img src="./mdpic/18.png" alt="合并" width="60%" height="60%">  
合并PR通常需要按照规则，比如说在这里就需要另外两个人review（评审）并同意

合并有几个选项，通常选择Squash，这样可以保持主分支的历史记录干净
<img src="./mdpic/19.png" alt="合并" width="60%" height="60%">  
